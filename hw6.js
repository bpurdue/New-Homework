...
console.log(document.querySelectorAll('table > tbody > tr > td:nth-of-type(2)'));
...
console.log(document.querySelectorAll('tbody > tr:nth-of-type(even)'));

// All odd TRs that are descendants of a TBODY

console.log(document.querySelectorAll('tbody > tr:nth-of-type(odd)'));
